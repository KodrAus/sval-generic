...
fn tag_equality() {
    for (a, b) in [
        (
            sval::Tag::Structural(None),
            sval::Tag::Structural(Some(sval::Label::new("a"))),
        ),
        (
            sval::Tag::Identified(Id::new(1u128.to_le_bytes()), Some(sval::Label::new("a"))),
            sval::Tag::Identified(Id::new(1u128.to_le_bytes()), Some(sval::Label::new("b"))),
        ),
    ] {
        assert_eq!(a, b);
